...
bool importModelDialog(std::string& path, GLFWwindow* window)
{
	...
	//The Assimp 3.0 library provides importers for a lot of file formats, including:- 3DS- BLEND - DAE (Collada)- IFC-STEP - ASE- DXF- HMP- MD2
	...
	ofn.lpstrFilter = TEXT("Supported Formats\0*.3DS;*.BLEND;*.DAE;*.ASE;*.DXF;*.HMP;*.MD2;*.MD3;*.MD5;*.MDC;*.MDL;*.NFF;*.PLY;*.STL;*.X;*.OBJ;*.SMD;*.LWO;*.LXO;*.LWS;*.XML;*.TER;*.AC3D;*.MS3D\0");
	ofn.nFilterIndex = 0;
