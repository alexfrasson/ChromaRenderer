...
public:
	...
	void   compileShader(const char * fileName, GLSLShader::GLSLShaderType type, vector<string> defines = vector<string>(), std::map<std::string, int> definesINT = std::map<std::string, int>()) throw (GLSLProgramException);
