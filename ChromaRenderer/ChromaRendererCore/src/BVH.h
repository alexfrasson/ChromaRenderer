...
public:
	...
	BvhNode* buildNode(int depth, std::vector<glm::vec3>& centroids, std::vector<BoundingBox>& bboxes, int startID, int endID);
	...
	bool splitMidpoint(std::vector<BVHPrimitiveInfo>& primitive, BoundingBox& trianglesbbox, int startID, int endID, int& splitindex, int& splitdim);
	bool splitMedian  (std::vector<BVHPrimitiveInfo>& primitive, BoundingBox& trianglesbbox, int startID, int endID, int& splitindex, int& splitdim);
