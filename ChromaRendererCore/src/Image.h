...
public:
	...
	void setColor(unsigned int widthPixelPos, unsigned int heightPixelPos, unsigned int r, unsigned int g, unsigned int b, unsigned int a);
	...
	inline const float* getBuffer() { return buffer; }
