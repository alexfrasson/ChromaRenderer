...
void GLSLProgram::compileShader(const char * fileName, GLSLShader::GLSLShaderType type, vector<string> defines, std::map<std::string, int> definesINT) throw (GLSLProgramException)
{
